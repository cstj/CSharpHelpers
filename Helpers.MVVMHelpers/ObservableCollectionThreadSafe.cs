...
namespace Helpers.MVVMHelpers
	{
	public abstract class ObservableCollectionThreadSafe : INotifyCollectionChanged, INotifyPropertyChanged
		{
		#region Private
        ...
        protected ObservableCollectionThreadSafe(LockTypeEnum lockType)
			{
			_lockType = lockType;
			_lockObj = new object();
			}
